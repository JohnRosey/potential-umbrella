...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      firstName: 'Ramiro Rosenbaum',
      lastName: 'Francisco Pouros',
      name: 'Curtis Beatty',
      username: 'Stefanie.Yost',
      password: 'APyLEaSTFbG9k91',
      email: 'Dulce_Hickle63@hotmail.com',
      mobileNo: '(051) 531-9011',
      userType: 11,
      resetPasswordLink: {},
      loginRetryLimit: 771,
      loginReactiveTime: '2024-06-21T09:47:31.274Z',
      id: '658ab18e1380483c9a3ad04b'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Sophie Baumbach',
        'lastName':'Loretta Stehr',
        'name':'Paula Barton',
        'username':'Nathanial.Feest92',
        'password':'P4rVIo8PQxO0CP9',
        'email':'Amani95@yahoo.com',
        'mobileNo':'(560) 987-6137',
