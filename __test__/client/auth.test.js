...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      firstName: 'Carolyn Pagac',
      lastName: 'Naomi Marvin',
      name: 'Rachael Blick',
      username: 'Rebeca_Medhurst',
      password: 'MPZU03RRXut_hAT',
      email: 'Shane.Metz@hotmail.com',
      mobileNo: '(816) 782-5229',
      userType: 53,
      resetPasswordLink: {},
      loginRetryLimit: 518,
      loginReactiveTime: '2024-05-10T05:21:17.765Z',
      id: '658ab18e1380483c9a3ad06b'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'firstName':'Ms. Deborah Durgan',
        'lastName':'Jamie Harber',
        'name':'Gregory Weimann',
        'username':'Dusty67',
        'password':'_RHmoBH1KirNXR6',
        'email':'Harry13@gmail.com',
        'mobileNo':'(868) 037-9787',
